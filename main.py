...
def show_post(post_id):
    ...
    if comment_form.validate_on_submit():
        ...
        db.session.commit()
    return render_template("post.html", year=year, post=requested_post, current_user=current_user, form=comment_form)
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", year=year, form=edit_form, is_edit=True, current_user=current_user)
